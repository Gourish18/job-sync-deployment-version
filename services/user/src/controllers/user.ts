...
//     WHERE user_id=${user.user_id}
//     RETURNING user_id, name,  bio, profile_pic
//   `;
//     res.json({
...
//     WHERE user_id=${user.user_id}
//     RETURNING user_id, name,  bio, resume
//   `;
//     res.json({
...
//   if (!resume) {
//     throw new ErrorHandler(400, "Please upload resume in your profile to apply for this job");
//   }
